...
import remarkGfm from "remark-gfm"; // Importa o plugin para suporte a GitHub Flavored Markdown
  ...
  ({ data }, ref) => {
    ...
    return (
      <div
        ref={ref}
        id="resume-preview"
        className="p-4 font-serif flex-grow"
      ...
      >
        <header className="text-center mb-8">
          ...
          >
            ...
            <span>
              {personalInfo.linkedin || "linkedin.com/in/seu-perfil"}
            </span>
          </div>
        </header>
        ...
        <section className="mb-6">
          <h2
            className="text-xl font-bold uppercase tracking-wider border-b-2 pb-1 mb-2"
            style={{ borderBottom: "2px solid #e2e8f0" }}
          >
            Resumo
          </h2>
          <div className="text-sm text-justify prose prose-sm max-w-none">
            ...
            <div className="space-y-4 mt-2">
              {experiences.map((exp) => (
                <div key={exp.id}>
                  ...
                  <div className="text-sm mt-1 text-justify prose prose-sm max-w-none">
                    <ReactMarkdown remarkPlugins={[remarkGfm]}>
                      {exp.description ||
